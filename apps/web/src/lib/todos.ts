/**
 * Planned features and follow-ups for the twomc.su platform.
 *
 * TODO: Marketplace/Аукцион — в разработке, будет позже
 * TODO: Верификация Minecraft ника — плагин в разработке
...
export const FUTURE_FEATURE_TODOS = [
  ...
  'Верификация Minecraft ника — плагин в разработке',
