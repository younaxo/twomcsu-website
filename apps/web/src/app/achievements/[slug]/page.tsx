      ...
      >
        <div className="flex flex-col gap-6 sm:flex-row sm:items-start">
          ...
          <div className="flex-1 space-y-3">
            ...
            {isAuthenticated && !isUnlocked && !achievement.isHidden && achievement.conditionValue !== null ? (
        ...
        <Card>
          ...
          <CardContent className="space-y-2 text-sm">
            ...
            {achievement.rewardTitle ? (
              <p>
                Титул: <span className="font-medium" style={{ color }}>{achievement.rewardTitle}</span>
              </p>
            ) : null}
            ...
            {!achievement.rewardRubies && !achievement.rewardTitle && !achievement.rewardBadgeType ? (
